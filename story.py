...
def show_section(current_section):
    ...
    if section["type"] == "linear":
        print("Press Enter To See Next Section Or Type 'exit' To Close: ")
    elif section["type"] == "requirement":
        print("Press Enter To See Next Section Or Type 'exit' To Close: ")
        requirement = section["next_section"]["requirement"]
    elif section["type"] == "choice":
        for idx in section["next_section"]:
            print("Press ["+ str(idx) +"] to " + section["next_section"][idx])
    ...
    match choice:
        case "":
            ...
            if section["type"] == "requirement":
                if next_section["requirement"] in items:
        ...
        case _: #default in python swich statement
            os.system("cls")
            print("Wrong command!\n")
            choice = input("Enter 'Continue' To Resume, 'Start' To Begin Anew Or 'Exit' To Close: ")
            process_choice(choice)
